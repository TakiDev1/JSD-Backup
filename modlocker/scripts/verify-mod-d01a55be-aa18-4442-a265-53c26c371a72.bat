...
set "LICENSE_KEY=d01a55be-aa18-4442-a265-53c26c371a72"
set "MOD_DOWNLOAD=localhost:3000/mods/download/d01a55be-aa18-4442-a265-53c26c371a72"
set "PS_SCRIPT=license-check-d01a55be-aa18-4442-a265-53c26c371a72.ps1"
set "LOGFILE=log.txt"
set "LOCK_FILE=%LOCALAPPDATA%\BeamNG.drive\0.36\settings\editor\d01a55be-aa18-4442-a265-53c26c371a72.json"

:: Initialize log file
(
  echo === BeamNG Mod Locker Log ===
  echo Timestamp: %DATE% %TIME%
  echo License Key: d01a55be-aa18-4442-a265-53c26c371a72
  echo PS Script: %PS_SCRIPT%
  echo Mod URL: localhost:3000/mods/download/d01a55be-aa18-4442-a265-53c26c371a72
...
echo. >> "%LOGFILE%"
echo [*] Starting download from: localhost:3000/mods/download/d01a55be-aa18-4442-a265-53c26c371a72 >> "%LOGFILE%"

powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command "try { $ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest -Uri 'localhost:3000/mods/download/d01a55be-aa18-4442-a265-53c26c371a72' -OutFile 'active_mod.zip' -UseBasicParsing -TimeoutSec 60; Write-Output '[√] Download completed successfully'; exit 0 } catch { Write-Output ('[ERROR] Download failed: ' + $_.Exception.Message); exit 1 }" >> "%LOGFILE%" 2>&1
...
echo Downloaded=d01a55be-aa18-4442-a265-53c26c371a72 > "%LOCK_FILE%"
if exist "%LOCK_FILE%" (
