...
set "LICENSE_KEY=a6fda864-e21f-4cb9-b2ae-9fd369e857ea"
set "MOD_DOWNLOAD=https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/a6fda864-e21f-4cb9-b2ae-9fd369e857ea"
set "PS_SCRIPT=license-check-a6fda864-e21f-4cb9-b2ae-9fd369e857ea.ps1"
set "LOGFILE=log.txt"
set "LOCK_FILE=%LOCALAPPDATA%\BeamNG.drive\0.36\settings\editor\a6fda864-e21f-4cb9-b2ae-9fd369e857ea.json"

:: Initialize log file
(
  echo === BeamNG Mod Locker Log ===
  echo Timestamp: %DATE% %TIME%
  echo License Key: a6fda864-e21f-4cb9-b2ae-9fd369e857ea
  echo PS Script: %PS_SCRIPT%
  echo Mod URL: https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/a6fda864-e21f-4cb9-b2ae-9fd369e857ea
...
echo. >> "%LOGFILE%"
echo [*] Starting download from: https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/a6fda864-e21f-4cb9-b2ae-9fd369e857ea >> "%LOGFILE%"

powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command "try { $ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest -Uri 'https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/a6fda864-e21f-4cb9-b2ae-9fd369e857ea' -OutFile 'active_mod.zip' -UseBasicParsing -TimeoutSec 60; Write-Output '[√] Download completed successfully'; exit 0 } catch { Write-Output ('[ERROR] Download failed: ' + $_.Exception.Message); exit 1 }" >> "%LOGFILE%" 2>&1
...
echo Downloaded=a6fda864-e21f-4cb9-b2ae-9fd369e857ea > "%LOCK_FILE%"
if exist "%LOCK_FILE%" (
