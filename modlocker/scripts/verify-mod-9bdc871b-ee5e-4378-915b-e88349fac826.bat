...
set "LICENSE_KEY=9bdc871b-ee5e-4378-915b-e88349fac826"
set "MOD_DOWNLOAD=http://localhost:3000/mods/download/9bdc871b-ee5e-4378-915b-e88349fac826"
set "PS_SCRIPT=license-check-9bdc871b-ee5e-4378-915b-e88349fac826.ps1"
set "LOGFILE=log.txt"
set "LOCK_FILE=%LOCALAPPDATA%\BeamNG.drive\0.36\settings\editor\9bdc871b-ee5e-4378-915b-e88349fac826.json"

:: Initialize log file
(
  echo === BeamNG Mod Locker Log ===
  echo Timestamp: %DATE% %TIME%
  echo License Key: 9bdc871b-ee5e-4378-915b-e88349fac826
  echo PS Script: %PS_SCRIPT%
  echo Mod URL: http://localhost:3000/mods/download/9bdc871b-ee5e-4378-915b-e88349fac826
...
echo. >> "%LOGFILE%"
echo [*] Starting download from: http://localhost:3000/mods/download/9bdc871b-ee5e-4378-915b-e88349fac826 >> "%LOGFILE%"

powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command "try { $ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest -Uri 'http://localhost:3000/mods/download/9bdc871b-ee5e-4378-915b-e88349fac826' -OutFile 'active_mod.zip' -UseBasicParsing -TimeoutSec 60; Write-Output '[√] Download completed successfully'; exit 0 } catch { Write-Output ('[ERROR] Download failed: ' + $_.Exception.Message); exit 1 }" >> "%LOGFILE%" 2>&1
...
echo Downloaded=9bdc871b-ee5e-4378-915b-e88349fac826 > "%LOCK_FILE%"
if exist "%LOCK_FILE%" (
