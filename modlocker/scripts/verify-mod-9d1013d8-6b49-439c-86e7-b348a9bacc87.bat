...
set "LICENSE_KEY=9d1013d8-6b49-439c-86e7-b348a9bacc87"
set "MOD_DOWNLOAD=http://localhost:3000/mods/download/9d1013d8-6b49-439c-86e7-b348a9bacc87"
set "PS_SCRIPT=license-check-9d1013d8-6b49-439c-86e7-b348a9bacc87.ps1"
set "LOGFILE=log.txt"
set "LOCK_FILE=%LOCALAPPDATA%\BeamNG.drive\0.36\settings\editor\9d1013d8-6b49-439c-86e7-b348a9bacc87.json"

:: Initialize log file
(
  echo === BeamNG Mod Locker Log ===
  echo Timestamp: %DATE% %TIME%
  echo License Key: 9d1013d8-6b49-439c-86e7-b348a9bacc87
  echo PS Script: %PS_SCRIPT%
  echo Mod URL: http://localhost:3000/mods/download/9d1013d8-6b49-439c-86e7-b348a9bacc87
...
echo. >> "%LOGFILE%"
echo [*] Starting download from: http://localhost:3000/mods/download/9d1013d8-6b49-439c-86e7-b348a9bacc87 >> "%LOGFILE%"

powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command "try { $ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest -Uri 'http://localhost:3000/mods/download/9d1013d8-6b49-439c-86e7-b348a9bacc87' -OutFile 'active_mod.zip' -UseBasicParsing -TimeoutSec 60; Write-Output '[√] Download completed successfully'; exit 0 } catch { Write-Output ('[ERROR] Download failed: ' + $_.Exception.Message); exit 1 }" >> "%LOGFILE%" 2>&1
...
echo Downloaded=9d1013d8-6b49-439c-86e7-b348a9bacc87 > "%LOCK_FILE%"
if exist "%LOCK_FILE%" (
