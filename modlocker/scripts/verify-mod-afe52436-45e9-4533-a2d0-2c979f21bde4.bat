...
set "LICENSE_KEY=afe52436-45e9-4533-a2d0-2c979f21bde4"
set "MOD_DOWNLOAD=http://localhost:3000/mods/download/afe52436-45e9-4533-a2d0-2c979f21bde4"
set "PS_SCRIPT=license-check-afe52436-45e9-4533-a2d0-2c979f21bde4.ps1"
set "LOGFILE=log.txt"
set "LOCK_FILE=%LOCALAPPDATA%\BeamNG.drive\0.36\settings\editor\afe52436-45e9-4533-a2d0-2c979f21bde4.json"

:: Initialize log file
(
  echo === BeamNG Mod Locker Log ===
  echo Timestamp: %DATE% %TIME%
  echo License Key: afe52436-45e9-4533-a2d0-2c979f21bde4
  echo PS Script: %PS_SCRIPT%
  echo Mod URL: http://localhost:3000/mods/download/afe52436-45e9-4533-a2d0-2c979f21bde4
...
echo. >> "%LOGFILE%"
echo [*] Starting download from: http://localhost:3000/mods/download/afe52436-45e9-4533-a2d0-2c979f21bde4 >> "%LOGFILE%"

powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command "try { $ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest -Uri 'http://localhost:3000/mods/download/afe52436-45e9-4533-a2d0-2c979f21bde4' -OutFile 'active_mod.zip' -UseBasicParsing -TimeoutSec 60; Write-Output '[√] Download completed successfully'; exit 0 } catch { Write-Output ('[ERROR] Download failed: ' + $_.Exception.Message); exit 1 }" >> "%LOGFILE%" 2>&1
...
echo Downloaded=afe52436-45e9-4533-a2d0-2c979f21bde4 > "%LOCK_FILE%"
if exist "%LOCK_FILE%" (
