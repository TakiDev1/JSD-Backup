...
set "LICENSE_KEY=30acb263-2a05-40c5-b72f-d1677e594793"
set "MOD_DOWNLOAD=https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/30acb263-2a05-40c5-b72f-d1677e594793"
set "PS_SCRIPT=license-check-30acb263-2a05-40c5-b72f-d1677e594793.ps1"
set "LOGFILE=log.txt"
set "LOCK_FILE=%LOCALAPPDATA%\BeamNG.drive\0.36\30acb263-2a05-40c5-b72f-d1677e594793.json"

:: Initialize log file
(
  echo === BeamNG Mod Locker Log ===
  echo Timestamp: %DATE% %TIME%
  echo License Key: 30acb263-2a05-40c5-b72f-d1677e594793
  echo PS Script: %PS_SCRIPT%
  echo Mod URL: https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/30acb263-2a05-40c5-b72f-d1677e594793
...
echo Downloaded=30acb263-2a05-40c5-b72f-d1677e594793 > "%LOCK_FILE%"
if exist "%LOCK_FILE%" (
