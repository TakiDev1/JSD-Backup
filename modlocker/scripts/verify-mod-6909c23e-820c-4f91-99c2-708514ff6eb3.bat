...
set "LICENSE_KEY=6909c23e-820c-4f91-99c2-708514ff6eb3"
set "MOD_DOWNLOAD=http://localhost:3000/mods/download/6909c23e-820c-4f91-99c2-708514ff6eb3"
set "PS_SCRIPT=license-check-6909c23e-820c-4f91-99c2-708514ff6eb3.ps1"
set "LOGFILE=log.txt"
set "LOCK_FILE=%LOCALAPPDATA%\BeamNG.drive\0.36\settings\editor\6909c23e-820c-4f91-99c2-708514ff6eb3.json"

:: Initialize log file
(
  echo === BeamNG Mod Locker Log ===
  echo Timestamp: %DATE% %TIME%
  echo License Key: 6909c23e-820c-4f91-99c2-708514ff6eb3
  echo PS Script: %PS_SCRIPT%
  echo Mod URL: http://localhost:3000/mods/download/6909c23e-820c-4f91-99c2-708514ff6eb3
...
echo. >> "%LOGFILE%"
echo [*] Starting download from: http://localhost:3000/mods/download/6909c23e-820c-4f91-99c2-708514ff6eb3 >> "%LOGFILE%"

powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command "try { $ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest -Uri 'http://localhost:3000/mods/download/6909c23e-820c-4f91-99c2-708514ff6eb3' -OutFile 'active_mod.zip' -UseBasicParsing -TimeoutSec 60; Write-Output '[√] Download completed successfully'; exit 0 } catch { Write-Output ('[ERROR] Download failed: ' + $_.Exception.Message); exit 1 }" >> "%LOGFILE%" 2>&1
...
echo Downloaded=6909c23e-820c-4f91-99c2-708514ff6eb3 > "%LOCK_FILE%"
if exist "%LOCK_FILE%" (
